...
const Popup = (props) => {
    ...
    return (
        <div className="popup" onClick={()=> dispatch(displayPopup("none"))} style={{display: display}}>
            <div className="popup__content" onClick={e => e.stopPropagation()}>
                <div className="popup__header">
                    <h3 className="popup__title">Create a new folder</h3>
                    <button className="button popup__close" onClick={()=> dispatch(displayPopup("none"))} >X</button>
                </div>
